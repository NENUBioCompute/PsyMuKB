...
if __name__ == '__main__':
	...
	mutation_impact_transcript = MutationTrancript("6326", "gene=6326,location=coding-dnm,position=166164448,chr=2")
	print(mutation_impact_transcript.get_mutation_impact_isoforms())
